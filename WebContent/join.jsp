	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav nav-tabs nav-justified">
				...
				<li class="active"><a href="join.jsp"><b>회원가입</b></a></li>
			</ul>
			...
			<div class="jumbotron" style="padding-top: 20px;">
				<form method="post" action="joinAction.jsp">
					...
					<div class="input-group">
					  ...
					  <input type="email" class="form-control" placeholder="이메일" aria-describedby="basic-addon1" name="userEmail" maxlength="20">
					</div>
					 <div class="form-group">
					    <div class="col-sm-offset-2 col-sm-10">
					      <div class="checkbox">
					        <label>
					          <input type="checkbox" style="text-align: left">약관에 동의해주세요.
					        </label>
					      </div>
					    </div>
					  </div>
