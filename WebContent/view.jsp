	...
	<div class="container">
		<div class="row">
			<table class = "table table-bordered" style="text-align:center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th colspan="3" style="backgroup-color: #eeeeee; text-align:center;" class="danger">게시판 글 보기</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td style="width: 20%; text-align: left;" class="success">글 제목</td>
